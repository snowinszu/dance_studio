...
export const PRESET_FIELDS: readonly PresetFieldDef[] = [
  ...
  { key: 'class_name', label: '班级', type: 'text', group: 'course', order: 2 },
  { key: 'current_level', label: '当前级别 / 考级进度', type: 'text', group: 'course', order: 3 },
  { key: 'enroll_date', label: '入学日期', type: 'date', group: 'course', order: 4 },
  { key: 'main_teacher', label: '主教老师', type: 'text', group: 'course', order: 5 },
  { key: 'class_schedule', label: '固定上课时段', type: 'text', group: 'course', order: 6 },
  { key: 'card_type', label: '卡种 / 课时包', type: 'text', group: 'course', order: 7 },
  { key: 'remaining_lessons', label: '剩余课时', type: 'number', group: 'course', order: 8 },
  { key: 'card_expire_date', label: '有效期至', type: 'date', group: 'course', order: 9 },
  {
    key: 'status',
    label: '学员状态',
    type: 'select',
